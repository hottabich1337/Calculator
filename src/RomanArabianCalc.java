...
public class RomanArabianCalc {
    ...
    public static void main (String[] args) throws IOException {
        ...
        if (stable00.charAt(0)<48||stable00.charAt(0)>57&&string03.charAt(0)<48||string03.charAt(0)>57){
            String resultRoman = convertNumToRoman(result);
            System.out.println(resultRoman);
        }else if (stable00.charAt(0)>=48&&stable00.charAt(0)<=57&&string03.charAt(0)>=48&&string03.charAt(0)<=57){
